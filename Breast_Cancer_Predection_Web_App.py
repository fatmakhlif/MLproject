# -*- coding: utf-8 -*-
"""
Created on Thu May  5 21:45:41 2022
...
loaded_model = pickle.load(open('C:/Users/pc/Downloads/trained_model.sav', 'rb'))
...
def main():
    ...
    if st.button('Biopsy Test Result'):
        diagnosis = breast_cancer_prediction([radius_mean,texture_mean,perimeter_mean,area_mean,smoothness_mean,compactness_mean,concavity_mean,concave_points_mean,symmetry_mean,fractal_dimension_mean,radius_se,texture_se,perimeter_se,area_se,
